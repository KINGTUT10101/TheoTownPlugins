...
if newsPack.newsPackSimCity == nil then
	newsPack.newsPackSimCity = true
end
...
function script:settings()
	return {
		{
			name = '(TNN) Toggle SimCity Headlines',
			value = newsPack.newsPackSimCity,
			onChange = function(newState)
				newsPack.newsPackSimCity = newState
...
function script:earlyInit ()
	if newsPack.newsPackSimCity == true then
		local simCityHeadlines = Array {
			...
			"Cab Fares In The City To Increase; Sims Brace For Worst",
			...
			"Your city Baker Wins Pickled Crumpet Toss Three Years Running",
			"Your City Baton Twirlers To Lead Local Parade",
			"Your City Makes Top 10 List",
			"News Ticker: Important Things You Need To Know, More Or Less",
			"News Ticker: A Quiet Voice Of Reason In A Noisy World",
			"News Ticker: Accept No Substitutes",
			"News Ticker: Don't Blame Us If You're Not Paying Attention",
			"News Ticker: Don't Blame Us, We Just Report It",
			"News Ticker: Easier To Find Because It Moves",
			"News Ticker: For When You Have To Know But Would Rather Not",
			"News Ticker: For When You Have To Know But Would Rather Not",
			"News Ticker: If It's Important To You, It Probably Is To Us Too",
			"News Ticker: If You Read It Here, That Means It Happened",
			"News Ticker: Information At A Readable Speed",
			"News Ticker: Information That's A Luxury, Not A Necessity",
			"News Ticker: Information With As Few Words As Possible",
			"News Ticker: Journalistic Integrity Without All The Advertising",
			"News Ticker: Just One Piece Of Information After Another",
			"News Ticker: Left To Right Through Aesthetic Design",
			"News Ticker: No Advertisements Since Before The Beginning",
			"News Ticker: Not For The Faint Of Heart",
			"News Ticker: Not Too Fast, Not Too Slow, Just Right",
			"News Ticker: Pretty Darn Accurate Most Of The Time",
			"News Ticker: Properly Spelled Words From Beginning To End",
			"News Ticker: Sometimes We're Just Here To Make You Smile",
			"News Ticker: Where We Report On Busses, Not Buses",
			"News Ticker: Your Total Information Source",
			"Your City Racewalkers Win All-City Title",
			"Your City Society Gather To Honor Visiting Potentate, Exchange Kitties",
			"Your City Tourist Bureau Launches City Beautification Project",
			"Your City Phonebooks Print All Wrong Numbers; Results In 15 New Marriages",
			"Consider A Career In Garbage Collection /n Crime Lord Spotted In city name; Mayor Says 'No Comment'",
			...
			"Here Comes The Sun",
			"House Made Entirely Of Broccoli Built In your city; Furniture Made Of Wheat Germ",
		...
		headlines:addAll (simCityHeadlines)
	end
end